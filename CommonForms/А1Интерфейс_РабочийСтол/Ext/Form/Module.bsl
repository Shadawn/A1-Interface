#Область ОбработчикиМеханизмов1_2_0
#Область СписокИзменений
//1.1.0 - добавлен обработчик "ПередЗакрытиемНаСервере".
//1.2.0 - добавлены стандартные обработчики "ПриИзмененииДоступностиОсновногоСервера", "ПередПереоткрытиемСДругогоСервера", "ПриПереоткрытииСДругогоСервера". 
#КонецОбласти
...
Процедура ПриИзмененииДоступностиОсновногоСервера(СтандартнаяОбработка)
	А1Э_Механизмы.ФормаПриИзмененииДоступностиОсновногоСервера(ЭтаФорма, СтандартнаяОбработка);
КонецПроцедуры

&НаКлиенте
Процедура ПередПереоткрытиемСДругогоСервера(Параметры, Отказ)
	А1Э_Механизмы.ФормаПередПереоткрытиемСДругогоСервера(ЭтаФорма, Параметры, Отказ);
КонецПроцедуры

&НаКлиенте
Процедура ПриПереоткрытииСДругогоСервера(ИсходнаяФорма, ПараметрыЗаполнения, СтандартнаяОбработка)
	А1Э_Механизмы.ФормаПриПереоткрытииСДругогоСервера(ЭтаФорма, ИсходнаяФорма, ПараметрыЗаполнения, СтандартнаяОбработка);
КонецПроцедуры
